...
public class MapsActivity extends FragmentActivity implements
    ...
    public void drawPath(String result) {
        ...
        new LovelyStandardDialog(this)
                ...
                .setTitle("Route Found!")
                .setMessage("Are you sure your want to pick this route? ")
                .setPositiveButton("Accept", new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("LocDistance", distance.intValue());
                ...
                .setNegativeButton("Pick another", null)
                .show();
    }
